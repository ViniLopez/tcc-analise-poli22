...
if perfil == 'Investidor':
  ...
  with st.form("Primeiro, faremos seu cadastro para depois você procurar seus investidores mais estratégicos!", clear_on_submit=False):
    ...
    telefone_founder = st.text_input("Telefone founder:", placeholder="(__) _____-____")
    ...
    num_clientes = st.number_input("Número de clientes:", min_value=1, value=1, step=1, format='%d')
