...
if perfil == 'Investidor':
  ...
  with col1:
    ...
    if isApiRunning:
      ...
      pandas_load = pd.read_json("tcc-analise-poli22/investor_json_examples/investor_empty.json")
  ...
  with col2:
    ...
    if isApiRunning:
      pandas_load = pd.read_csv("tcc-analise-poli22/investor_json_examples/Tese_Investimento_Exemplo.csv")
